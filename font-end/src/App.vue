                        ...
                        <v-card-title class="lighten-2" style="background-color: #188872">
                            <h2 class="display-1 white--text font-weight-light">首席顾问专家：<br>
                                <a href="https://statistics.stanford.edu/people/tze-leung-lai"
                                   style="text-decoration: none; color: white">黎子良院士</a>
                            </h2>
                        </v-card-title>
                        <v-container>
                            <v-row>
                        ...
                        <v-card-title class="lighten-2" style="background-color: #188872">
                            <h2 class="display-1 white--text font-weight-light">执行负责人：<br>
                                <a href="https://im.nju.edu.cn/dxy1/list.htm"
                                   style="text-decoration: none; color: white">丁晓蔚博士</a>
                            </h2>
                        </v-card-title>
                        <v-container>
                            <v-row>
        ...
        data: () => ({
          showTabOne:false,
            ...
            humans: [
                ...
                {
                    title: "公益金融+科技人才培养",
                    content: "温度和时代使命感是当下金融人才的必备素养。南京大学普惠三农金融科技创新研究中心公益金融科技(FinTech4Good)工作组，简称“ 南京大学公益金融科技(FinTech4Good)团队”（这是以后行走江湖的名号）正在着力孵化项目“基于区块链可信大数据人工智能的三农金融创新和人才培养服务平台”，服务于祖国全面建成小康社会的目标实现。"
                },
